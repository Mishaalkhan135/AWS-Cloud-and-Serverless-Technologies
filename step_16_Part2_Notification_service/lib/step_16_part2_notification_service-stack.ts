...
export class Step16Part2NotificationServiceStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const helloLambda = new lambda.Function(this, "HelloHandler", {
      ...
      handler: "hello.handler",
        ...
        // adding a dead letter queue and to save failed messages
        ...
        myTopic.addSubscription(
          new subscriptions.LambdaSubscription(helloLambda, {
            filterPolicy: {//to filter messages in message attributes
